...
export function DataTableVacations<TData, TValue>({
  columns,
  data,
      ...
      <div>
              ...
              {table.getRowModel().rows?.length ? (
                ...
                <TableRow>
                  <TableCell colSpan={columns.length} className="h-24 text-center">
                    No hay solicitudes de vacaciones por aprobar.
                  </TableCell>
                </TableRow>
              )}
            </TableBody>
        ...
        <div className="flex items-center justify-end space-x-2 py-4">
          <Button
            ...
            disabled={isApproving || !table.getCanPreviousPage()}
          >
            Previous
          </Button>
          <Button
            ...
            disabled={isApproving || !table.getCanNextPage()}
          >
            Next
          </Button>
        </div>
